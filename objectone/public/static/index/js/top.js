...
$(".active").mouseenter(function () {
    ...
    $(this).children(".hot").children("div").css({"background":"url(img/images/cswd-dhdy-8.png)no-repeat 0 -90px","marginTop":"3px","marginLeft":"2px"});
}).mouseleave(function(){
    $(this).children(".activelist").hide();
    $(this).children(".hot").children("div").css({"background":"url(img/images/cswd-dhdy-8.png)no-repeat 3px -429px","marginTop":"0","marginLeft":"0"});
});
/*导航栏下拉菜单*/
