...
use app\admin\model\Zhuangti as Links;
class Zhuangti extends Base
{
       ...
       // var_dump($file);exit;
        ...
        $info = $file->validate(['size'=>1567118,'ext'=>'jpg,png,gif'])->move(ROOT_PATH . 'public' . DS . 'uploads'); 
            ...
            echo $file->getError(); 
             ...
             $data['addtime']=time();
              //var_dump($data);exit;
              $num= \think\Db::table('ht_zhungti_type')->insert($data);
